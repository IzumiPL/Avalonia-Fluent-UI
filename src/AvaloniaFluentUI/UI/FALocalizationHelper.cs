...
namespace AvaloniaFluentUI.UI;

/// <summary>
/// Helper class for storing localized string for AvaloniaFluentUI/WinUI controls
/// </summary>
/// <remarks>
...
public partial class FALocalizationHelper
{
    ...
    {
        using var al = AssetLoader.Open(new Uri("avares://AvaloniaFluentUI/Assets/ControlStrings.json"));
